    ...
    public class RedeSocialController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByEvento(int eventoId)
        {
            try
            {
                ...
                if (redeSociais == null) return NotFound();
            ...
            catch (Exception ex)
            {
                ...
                $"Erro ao tentar recuperar Redes Sociais do evento id:{eventoId}. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> GetByPalestrante()
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError,
                $"Erro ao tentar recuperar Redes Sociais de palestrante. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            try
            {
                ...
                if (redeSocials == null) return NotFound();
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError,
                $"Erro ao tentar salvar Rede Social no evento id{eventoId}. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> SaveByPalestrante(RedeSocialDto[] models)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError,
                $"Erro ao tentar salvar Rede Social no Palestrante id:{User.GetUserId()}. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByEvento(int eventoId, int redeSocialId)
        {
            try
            {
                ...
                return await _redeSocialService.DeleteByEvento(eventoId, redeSocial.id)
                    ? Ok(new { message = "RedeSocial deletado!" })
                    : throw new Exception("Aconteceu um problema não específico ao tentar deletar a Rede Social.");
            }
            catch (Exception ex)
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError,
